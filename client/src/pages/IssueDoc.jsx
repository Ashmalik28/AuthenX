        ...
        <div className='w-screen h-screen flex flex-col text-white'>
            ...
            <div className='flex flex-1 h-100vh mt-[60px] bg-gray-300'> 
                ...
                {DocType.map((type) => (
                    ...
                    <div className='xl:text-3xl text-3xl text-black text-center font-semibold'>
                   ...
                   {docHash === null ? (
                    <div className='text-black m-2 flex flex-col items-center'>
                      ...
                      <div className='text-center mt-2 text-gray-400 text-sm xl:text-base font-semibold'>The QR code will appear here once you issue a document for direct verification</div>
                    </div>
                     ) : (
                    <div className='flex flex-col items-center'>
