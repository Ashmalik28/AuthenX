...
const HeroSection = () => {
    return (
        <div className="w-full 2xl:max-w-[1800px] mx-auto flex flex-col lg:flex-row justify-between p-5 lg:p-2 ">
            ...
            <div className='flex w-full justify-center lg:justify-start items-center lg:items-start mt-6 lg:mt-9 lg:ml-1 gap-7'>
            ...
            <div className='flex flex-col justify-center lg:justify-start items-center mt-5 lg:mt-38 lg:pr-20 '>
                <img className='max-w-xs lg:max-w-lg 2xl:max-w-2xl' src={image} alt="hero" />
            </div>
