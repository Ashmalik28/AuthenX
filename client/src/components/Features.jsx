...
const FeatureCardUpperData = [
    {svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-9">
     <path fill-rule="evenodd" d="M7.502 6h7.128A3.375 3.375 0 0 1 18 9.375v9.375a3 3 0 0 0 3-3V6.108c0-1.505-1.125-2.811-2.664-2.94a48.972 48.972 0 0 0-.673-.05A3 3 0 0 0 15 1.5h-1.5a3 3 0 0 0-2.663 1.618c-.225.015-.45.032-.673.05C8.662 3.295 7.554 4.542 7.502 6ZM13.5 3A1.5 1.5 0 0 0 12 4.5h4.5A1.5 1.5 0 0 0 15 3h-1.5Z" clip-rule="evenodd" />
     <path fill-rule="evenodd" d="M3 9.375C3 8.339 3.84 7.5 4.875 7.5h9.75c1.036 0 1.875.84 1.875 1.875v11.25c0 1.035-.84 1.875-1.875 1.875h-9.75A1.875 1.875 0 0 1 3 20.625V9.375Zm9.586 4.594a.75.75 0 0 0-1.172-.938l-2.476 3.096-.908-.907a.75.75 0 0 0-1.06 1.06l1.5 1.5a.75.75 0 0 0 1.116-.062l3-3.75Z" clip-rule="evenodd" />
    </svg> , headline : "Secure Document Issuance" ,  text : "Issue tamper-proof digital documents secured through advanced blockchain technology." , stats : "12,000+" , stattext : "Documents Secured" , width : "xs:w-[85%] lg:w-72 xl:w-80 sm:hidden lg:flex" , bgcolor : "bg-[#d8fcfe]"
    },
    {svg : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-9">
     <path d="M4.5 6.375a4.125 4.125 0 1 1 8.25 0 4.125 4.125 0 0 1-8.25 0ZM14.25 8.625a3.375 3.375 0 1 1 6.75 0 3.375 3.375 0 0 1-6.75 0ZM1.5 19.125a7.125 7.125 0 0 1 14.25 0v.003l-.001.119a.75.75 0 0 1-.363.63 13.067 13.067 0 0 1-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 0 1-.364-.63l-.001-.122ZM17.25 19.128l-.001.144a2.25 2.25 0 0 1-.233.96 10.088 10.088 0 0 0 5.06-1.01.75.75 0 0 0 .42-.643 4.875 4.875 0 0 0-6.957-4.611 8.586 8.586 0 0 1 1.71 5.157v.003Z" />
    </svg> , headline : "Trusted Organizations Only" ,  text : "Partner with verified organizations ensuring compliance, reliability, and trust." , stats : "850+" , stattext : "Verified Partners" , width : "xs:w-[85%] lg:w-72 xl:w-80" , bgcolor : "bg-[#fef2d4]"
    },
    {svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-9">
    ...
    </svg> , headline : "Seamless Global Accessibility" ,  text : "Access and verify documents anytime, anywhere with decentralized storage." , stats : "30+" , stattext : "Countries Covered" , width : "xs:w-[85%] lg:w-72 xl:w-80" , bgcolor : "bg-[#dafed8]"
    }
]
const FeatureCardLowerData = [
    ...
    </svg> , headline : "User-Friendly Platform" ,  text : "Experience a user-friendly platform with seamless onboarding and effortless use, simplifying blockchain adoption, empowering organizations and individuals to verify documents securely without technical barriers." , stats : "95%" , stattext : "Positive User" , width : "xs:w-[90%] lg:w-[446px] xl:w-124" , bgcolor: "bg-[#e2dfff]"
    },
]
const Features = () => {
    return (
        <span className="max-w-screen flex flex-col items-center">
            <div className="flex w-full flex-col items-center mt-8">
                <span className="xs:text-4xl text-2xl mb-1" >
                    🚀
                </span>
                <span className="flex gap-3">
                    <span className="text-2xl xs:text-3xl lg:text-4xl ">Powering</span><span className="lg:text-4xl xs:text-3xl text-2xl font-bold">Trusted</span>
                </span>
                <span className="flex gap-3">
                  <span className="lg:text-4xl xs:text-3xl text-2xl font-bold">Document</span><span className="lg:text-4xl text-2xl xs:text-3xl">Verification</span>  
                </span>
                <span className="xl:w-3/7 lg:w-4/6 sm:w-4/5 px-3 lg:px-0 flex text-center mt-3 text-sm lg:text-base">
