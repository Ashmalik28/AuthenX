...
const FeatureCardUpperData = [
    ...
    </svg> , headline : "Trusted Organizations Only" ,  text : "Partner with verified organizations ensuring compliance, reliability, and trust." , stats : "850+" , stattext : "Verified Partners" , width : "w-[80%] lg:w-80" , bgcolor : "bg-[#fef2d4]"
    },
    {svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-9">
    ...
    </svg> , headline : "Seamless Global Accessibility" ,  text : "Access and verify documents anytime, anywhere with decentralized storage." , stats : "30+" , stattext : "Countries Covered" , width : "w-[80%] lg:w-80" , bgcolor : "bg-[#dafed8]"
    }
]
const FeatureCardLowerData = [
    ...
    </svg> , headline : "User-Friendly Platform" ,  text : "Experience a user-friendly platform with seamless onboarding and effortless use, simplifying blockchain adoption, empowering organizations and individuals to verify documents securely without technical barriers." , stats : "95%" , stattext : "Positive User" , width : "w-[90%] lg:w-124" , bgcolor: "bg-[#e2dfff]"
    },
]
const Features = () => {
    return (
